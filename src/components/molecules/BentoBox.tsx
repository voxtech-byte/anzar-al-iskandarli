...
export function BentoBox({ children, className, delay = 0, ...props }: BentoBoxProps) {
  return (
    ...
    >
      ...
      <div className="absolute -inset-x-20 -inset-y-20 bg-gradient-to-br from-primary/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none rounded-full blur-3xl group-hover:translate-x-10 group-hover:translate-y-10" />
