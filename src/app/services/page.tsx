  ...
  return (
    <div className="flex flex-col gap-32 pb-32 max-w-7xl mx-auto px-6 lg:px-12">
      ...
      <section className="pt-24 md:pt-32 text-center max-w-3xl mx-auto">
        ...
        <Typography variant="h1" className="text-5xl md:text-7xl font-extrabold mb-8 tracking-tight leading-tight">
      ...
      <section>
        <div className="mb-16 md:mb-24 flex items-center gap-8">
          <Typography variant="h2" className="text-4xl md:text-5xl font-bold shrink-0">Why AI-Assisted Workflow?</Typography>
      ...
      <section>
        <div className="mb-16 md:mb-24 flex flex-row-reverse items-center gap-8">
          <Typography variant="h2" className="text-4xl md:text-5xl font-bold shrink-0">Core Arsenal</Typography>
          <div className="h-[1px] w-full bg-border" />
        </div>
